...
db_instance_identifier = 'mydbinstance2'
...
try:
    response = ec2.run_instances(
        ImageId='ami-0e449927258d45bc4',  # Reemplazar con un AMI válido para tu región
        MinCount=1,
        MaxCount=1,
        ...
        IamInstanceProfile={
            'Name': 'LabInstanceProfile'  # Asegúrate de que este perfil tenga permisos para SSM
        }
    )
